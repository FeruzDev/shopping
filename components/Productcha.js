    ...
    <div>
                        ...
                        <div className={styles.productInfo}>
                          ...
                          <div>
                            <p
                              ...
                              className="fw-bold text-dark-emphasis mt-2 pt-2"
                            >
                              {product.price?.slice(0, -3)} сум
                            </p>
                            <button
          ...
          <div className="col-md-3">
            {cart.length > 0 && (
              <div className={styles.cart}>
                ...
                {cart.map((item) => (
                  <div key={item.id} className={styles.cartItem}>
                    <span>
                      ...
                      >
                        <button
                          className="btn btn-outline-success fw-bold d-flex align-items-center justify-content-center p-0"
                        ...
                        >
                          <span style={{ marginTop: "-4px", fontSize: "16px" }}>
                            +
                          </span>
                        </button>
                      </div>
                ...
                <p className="mt-3">
                  <strong>Общая сумма: {totalPrice} сум</strong>
                </p>
      ...
      <CustomModal isOpen={modalIsOpen} onClose={closeModal}>
        <div className="order-box mt-2" style={{ width: "300px" }}>
          ...
          <button
            className="mt-4 w-100 btn btn-success"
            disabled={!reg || !name || !phone}
            onClick={() => sendOrder()}
          >
            Заказ
          </button>
